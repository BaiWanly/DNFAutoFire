...
### 2026-5-15 v0.21
- [优化]优化了配置管理逻辑，不再需要手动保存
- [优化]新增 GUI 主题与控件包装层，主界面和扩展设置窗口改为统一控件创建入口，便于后续调整布局和外观
- [优化]主界面改用系统主题按钮，使按钮外观与扩展设置窗口保持一致
- [优化]主界面键盘区、预设区、扩展功能区和重复扩展设置窗口改为自动计算布局坐标
- [特性]新增自动宠物技能功能
