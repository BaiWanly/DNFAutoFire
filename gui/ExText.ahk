...
global exText := Map(
    ...
    "ComboImportPartialPrefix", "已导入 ",
    "ComboImportPartialMiddle", " 套连招方案；因数量上限跳过 ",
    "ComboImportPartialSuffix", " 套。",
    "ComboImportFullPrefix", "当前已经达到 ",
    "ComboImportFullSuffix", " 套连招方案上限，无法继续导入。",
