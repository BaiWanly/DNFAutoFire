...
global gQuickSwitchGui := 0
global gQuickSwitchCtrls := Map()

GuiRegistry.Define("QuickSwitch", QuickSwitchBuildGui)

QuickSwitchBuildGui() {
    global gQuickSwitchGui, gQuickSwitchCtrls
    gQuickSwitchGui := Gui("-MinimizeBox -MaximizeBox -SysMenu +AlwaysOnTop -Theme +0x800000")
    gQuickSwitchCtrls := Map()
    ...
    return gQuickSwitchGui
}

QuickSwitchGetCtrl(name) {
    global gQuickSwitchCtrls
    GuiRegistry.Ensure("QuickSwitch")
