...
GuiRegistry.Define("Setting", SettingBuildGui)

SettingBuildGui() {
    global gSettingGui, gSettingCtrls, gSettingSwitchUi, __SettingGeneralCtrls, __SettingAboutCtrls
    gSettingGui := Gui("-MinimizeBox -MaximizeBox -Theme")
    gSettingCtrls := Map()
    gSettingSwitchUi := Map()
    __SettingGeneralCtrls := []
    __SettingAboutCtrls := []
    ...
    gSettingCtrls["SettingQuickChangeHotKey"] := gSettingGui.Add("Hotkey", "vSettingQuickChangeHotKey x126 y166 w112 h24 -E0x200 Border")
