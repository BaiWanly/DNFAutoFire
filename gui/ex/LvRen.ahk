...
__lvLb := GuiTheme_ListBoxFlatOutline(gLvRenGui, 14, 32, 108, 176)
gLvRenCtrls["LvRenKeysListBox"] := gLvRenGui.Add("ListBox", Format("vLvRenKeysListBox x{} y{} w{} h{} -E0x200 -Border -VScroll -HScroll", __lvLb.x, __lvLb.y, __lvLb.w, __lvLb.h))
