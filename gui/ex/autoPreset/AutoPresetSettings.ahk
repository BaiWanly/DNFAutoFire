...
global gAutoPresetSettingsGui := 0
global gAutoPresetSettingsCtrls := Map()
global gAutoPresetSelectedPreset := ""
global gAutoPresetSettingsSwitchUi := ""

GuiRegistry.Define("AutoPresetSettings", AutoPresetSettingsBuildGui)

AutoPresetSettingsBuildGui() {
    global gAutoPresetSettingsGui, gAutoPresetSettingsCtrls, gAutoPresetSettingsSwitchUi
    gAutoPresetSettingsGui := Gui("-MinimizeBox -MaximizeBox -Theme", GuiText.AutoPresetSettingsTitle())
    gAutoPresetSettingsCtrls := Map()
    ...
    return gAutoPresetSettingsGui
}

AutoPresetSettingsGetCtrl(name) {
    global gAutoPresetSettingsCtrls
    GuiRegistry.Ensure("AutoPresetSettings")
