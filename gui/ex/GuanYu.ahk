...
__gyLb := GuiTheme_ListBoxFlatOutline(gGuanYuGui, 14, 32, 108, 176)
gGuanYuCtrls["GuanYuKeysListBox"] := gGuanYuGui.Add("ListBox", Format("vGuanYuKeysListBox x{} y{} w{} h{} -E0x200 -Border -VScroll -HScroll", __gyLb.x, __gyLb.y, __gyLb.w, __gyLb.h))
