...
quickSwitchList := gQuickSwitchGui.Add("ListBox", UiLayoutRect(gQuickSwitchLayout, 12, 12, 244, 132, "vQuickSwitchList -VScroll"))
UiListBoxWheel_Attach(quickSwitchList)
gQuickSwitchCtrls["QuickSwitchList"] := quickSwitchList
